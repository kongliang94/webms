...
<blockquote class="layui-elem-quote">
    <p><span style="color:#1E9FFF;">项目简介：</span>
        webms,后台管理系统,采用SpringBoot构建整个项目框架,Shiro权限验证，mybatis+druid数据持久化
...
<div class="row">
    <div class="sysNotice col">
        ...
        <table class="layui-table">
            ...
            <tr>
                <td>系统名称:</td>
                <td class="version">webms后台管理系统</td>
            </tr>
            <tr>
                <td>版本信息:</td>
            ...
            <tr>
                <td>官网地址</td>
                <td class="server"><a href="http://www.yangxiaobing.org" class="official" target="_blank"></a>
                </td>
            </tr>
            <tr>
                <td>当前用户权限</td>
    ...
    <div class="sysNotice col">
        ...
        <div class="layui-elem-quote layui-quote-nm">
            ...
            <p>&nbsp;&nbsp;&nbsp;webms是一个自由软件，您可以自由分发、修改其中的源代码或者重新发布它，
                新的任何修改后的重新发布版必须同样在遵守GPL3或更后续的版本协议下发布. 关于GPL协议的细则请参考COPYING文件，
                您可以在webms的相关目录中获得GPL协议的副本， 如果没有找到，请连接到 http://www.gnu.org/licenses/ 查看.
            </p>

            <p><span style="color:#1E9FFF;">源码地址：</span>
                <a class="layui-btn layui-btn-mini" target="_blank"
                   href="https://github.com/kongliang94/webms">点此跳转</a>
            </p>
...
<div class="row">
    <div class="sysNotice col">
        ...
        <div class="layui-elem-quote layui-quote-nm">
            <h3><span style="color:#f00;"># beta-1.0.0 (测试版) - 2017-</span></h3>
            <p>*SpringBoot项目构建</p>
