...
public enum ResultConstants {
	...
	private ResultConstants(Integer code, String msg) {
		this.code = code;
		this.msg = msg;
	}
	...
	public ResultConstants getByCode(Integer code){
		for(ResultConstants mc : values()){
	...
	public static void main(String[] args){
		for (ResultConstants msg : values()) {
