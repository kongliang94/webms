...
import com.kongl.cms.common.constant.ResultConstants;
import com.kongl.cms.dao.RoleMapper;
import com.kongl.cms.dao.UserMapper;
import com.kongl.cms.dao.UserRoleMapper;
import com.kongl.cms.domain.bo.ResultInfo;
import com.kongl.cms.domain.vo.Role;
import com.kongl.cms.domain.vo.User;
import com.kongl.cms.domain.vo.UserRole;
...
public class UserService {
    ...
    public User selectUserByloginName(String  userLoginName){
        return userMapper.selectUserByloginNameAndStatus(userLoginName, Long.valueOf(ResultConstants.SYS_USER_STATUS_0.getCode()));
    }
    /**
     * 根据用户Id查询用户信息
     * @param userId 用户Id
     ...
     */
    @Transactional
    public ResultInfo saveOrUpdateUser(User user, String loginName) throws Exception{
        log.info("保存用户信息开始");
     ...
     */
    @Transactional
    public ResultInfo saveUserRole(Integer userId,String roleIds,String longinName) throws Exception{
